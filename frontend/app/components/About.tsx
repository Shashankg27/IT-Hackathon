...
export default function About() {
  return (
    <section id="about" className="section-navy" style={{ background: '#0F1A18', padding: '100px 24px' }}>
      <div className="dots-grid" />
      <div className="bg-text-large" style={{ bottom: '-5%', left: '-5%', opacity: 0.05, color: '#f8fafc' }}>ABOUT</div>
      <div className="container">

        {/* ── Section Heading ── */}
        <ScrollReveal>
          <h2 className="heading-lg" style={{ color: '#5BE2B3', borderBottomColor: '#5BE2B3' }}>ABOUT US</h2>
        </ScrollReveal>
        ...
        <ScrollReveal delay={200}>
          <p style={{ color: '#94a3b8', fontSize: '0.95rem', lineHeight: 1.8, textAlign: 'justify', marginBottom: 40 }}>
        ...
        <div style={{ display: 'flex', gap: 30, flexWrap: 'wrap', marginBottom: 48 }}>
          ...
          <ScrollReveal delay={300} animation="reveal-left" className="flex-1 min-w-[280px]">
            <div className="brochure-card hover:border-[#5BE2B3] transition-colors" style={{ backgroundColor: '#1A2F2B', color: 'white', padding: '32px', border: '1px solid #2C3E3A', borderRadius: '8px' }}>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                {[
                  ...
                  <li key={m.id} style={{ display: 'flex', gap: 10, marginBottom: 10, alignItems: 'flex-start' }}>
                    <span style={{ color: '#5BE2B3', fontWeight: 800, fontSize: '0.8rem', minWidth: 28, marginTop: 2 }}>{m.id}</span>
                    <span style={{ fontSize: '0.85rem', color: '#94a3b8', lineHeight: 1.7, textAlign: 'justify' }}>{m.text}</span>
                  </li>
                ))}
              </ul>
              <div className="brochure-line bg-[#5BE2B3]" style={{ marginTop: 24, height: '2px', width: '40px' }} />
